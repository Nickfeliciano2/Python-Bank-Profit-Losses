...
print ("Average Change: $", round(monthly_change,2))
print ("Greatest Increase in Profits: ", month_increase, "( $", profit_increase, ")")
print ("Greatest Decrease in Profits: ", month_decrease, "( $", profit_decrease, ")")